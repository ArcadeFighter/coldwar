  ...
  <div class="filters">
    ...
    <div class="symbols" v-if="showSymbols">
      <eva-icon class="info" 
                ...
                :content="'Pro Diamond kamufláž stačí udělat určitý počet zbraní na Gold. Například pro Assault Rifles stačí udělat 5 zbraní na Gold a budeš mít Diamond kamufláž.'"></eva-icon>
      <div class="info mobile">
        <eva-icon name="question-mark-circle" fill="white"></eva-icon>
        <p>Pro Diamond kamufláž stačí udělat určitý počet zbraní na Gold. Například pro Assault Rifles stačí udělat 5 zbraní na Gold a budeš mít Diamond kamufláž.</p>
      </div>
    </div>
  </div>
</template>
