    ...
    return {
      ...
      settings: [
        ...
        },
        {
          ...
          description: 'Resetuje tvůj aktuální progress DM Ultra kamufláže.',
        ...
        },
        {
          ...
          description: 'Resetovat všechen tvůj progress u obou kamufláží (DM Ultra & Dark Aether).',
          warning: 'Tato akce je nevratná.',
          action: 'resetAll',
          button: 'Resetovat progress'
        }
            ...
            setTimeout(async () => {
              await this.$store.dispatch('importProgress', JSON.parse(e.target.result))
                .then(() => {
                  ...
                  this.$notify({
                    type: 'success',
                    title: `Progress úšpěšně importován!`,
                  });
                });
            }, 500);
          };
